...
echo -e "[CONFIGURE][ARGS] USD-MAYA-PXR VERSION: ${USD_MAYA_PXR_VERSION}"

# We check if the arguments variables we need are correctly set.
# If not, we abort the process.
if [[ -z ${EXTRACT_PATH} || -z ${BUILD_PATH} || -z ${INSTALL_PATH} || -z ${USD_MAYA_PXR_VERSION} ]]; then
    echo -e "\n"
...
# We run the configuration script of USD-Maya-Pxr.
echo -e "\n"
echo -e "[CONFIGURE] Running the configuration script from USD-Maya-Pxr-${USD_MAYA_PXR_VERSION}..."
echo -e "\n"
...
rm ${EXTRACT_PATH}/third_party/maya/CMakeLists.txt
...
cp ${REZ_BUILD_SOURCE_PATH}/config/third_party/maya/CMakeLists.txt ${EXTRACT_PATH}/third_party/maya/CMakeLists.txt
...
echo -e "\n"
echo -e "[CONFIGURE] Finished configuring USD-Maya-Pxr-${USD_MAYA_PXR_VERSION}!"
echo -e "\n"
